...
$latestProducts = array_filter($products, function ($product) {
    return $product['sub_category'] == 'men_latest';
});
...
<?php include 'header.html'; ?>
                        ...
                        <div class="card-body bg-custom-color">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col text-end">
                                    ...
                                    <a href="cart.php?action=add&id=<?php echo $product['id']; ?>&name=<?php echo $product['name']; ?>&price=<?php echo $product['price']; ?>&image=<?php echo $product['image_path']; ?>">
    <i class="ri-shopping-cart-fill"></i>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
            ...
            $featuredProducts = array_filter($products, function ($product) {
                return $product['sub_category'] == 'featured';
            });
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
        ...
        $CasualProducts = array_filter($products, function ($product) {
            return $product['sub_category'] == 'casual';
        });
